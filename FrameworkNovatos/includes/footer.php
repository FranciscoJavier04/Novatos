    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 text-center">
                <p class="texto24 text-uppercase mb-4">Aviso Legal</p>
                <p class="texto24 text-uppercase mb-4">Política de Privacidad</p>
                <p class="texto24 text-uppercase mb-4">Política de Cookies</p>
            </div>
        </div>
    </div>
</footer>
