<nav class="navbar navbar-expand-md sticky-top bg-secondary fs-4 fw-bold text-danger">
  <div class="container-fluid">
    ...
    <button class="navbar-toggler border-0 fs-4 text-danger" type="button" data-bs-toggle="collapse" data-bs-target="#navbar">
    ...
    <div class="collapse navbar-collapse" id="navbar">
      <ul class="navbar-nav ms-auto me-2">
        ...
        <li class="nav-item">
          <a class="nav-link ms-3 me-3 fs-4 text-danger" href="login.php"><i class="fas fa-user"></i></a>
        </li>
        <li class="nav-item">
